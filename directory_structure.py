...
EXCLUDE_DIRS = ['venv', 'node_modules', '__pycache__', '.git', 'migrations', '.mypy_cache', 'build', 'lib/', '.idea', '.vscode', '.ruff_cache']

def print_directory_structure(root_dir: str, prefix: str = "", is_root: bool = True):
    try:
...
if __name__ == "__main__":
    ...
    offset = input("Enter a relative path to change the current directory, or press Enter to skip: ").strip()
